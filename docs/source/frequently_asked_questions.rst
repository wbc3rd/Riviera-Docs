...
.. dropdown:: What compute resources does Riviera offer?
...
.. dropdown:: How do I request a compute node? 
    ...
    See `Slurm <https://riviera-docs.readthedocs.io/en/latest/slurm.html>`_ for more information on running and requesting a compute node.
